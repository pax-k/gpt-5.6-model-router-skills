...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_manifest_is_v040_and_hook_bearing(self):
        manifest = json.loads((PLUGIN / ".codex-plugin/plugin.json").read_text())
        self.assertRegex(manifest["version"], r"^0\.4\.0\+codex\.[A-Za-z0-9.-]+$")
    ...
    def test_ten_schema5_bounded_roles(self):
    ...
    def test_governed_contract(self):
        ...
        self.assertIn("ordinary noncritical route choices remain advisory", skill.lower())
